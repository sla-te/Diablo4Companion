...
namespace D4Companion.ViewModels.Dialogs
{
        ...
        IRecipient<MobalyticsProfilesLoadedMessage>
    {
        ...
        private async void MergeBuildsExecute()
        {
            ...
            var affixPreset = AffixPresetMerger.Merge(SelectedAffixPresetBuild1, SelectedAffixPresetBuild2, buildName,
                new AffixPresetMergeColors(ChangeColorBuild1, ColorBuild1, ChangeColorBuild2, ColorBuild2, ChangeColorBuild12, ColorBuild12));
